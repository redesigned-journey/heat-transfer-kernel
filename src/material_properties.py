...
cladding_props_master = {'Porous Carbon Buffer': {'rho': 1.00, 'k': 0.5,
                                                  'c': 1.5},
                         'Inner Pyrolytic Carbon': {'rho': 1.90, 'k': 4.0,
                                                    'c': 1.5},
...
def material_property_library(material_info):
    ...
    outputs
    -------
    material_properties: Nested dictionary which contains the material
    properties for each material as well as their radii and position in the
    particle
    """
