...
parser.add_argument("-tr","--transient", nargs='+', type=float, default=[],required=False,
	                help="Runs transient model. Enter simulation time and then number of timesteps seperated by a space")
