...
def build_matrix_A(material_property_library, mesh, materials):
    ...
    A[materials[0][1]-1, materials[0][1]-1] = 1
    ...
    for i in range(2, materials[0][1]-1): #Length set to fueled node length
